<?php
    ...
    if ($db->connect_error) {
        die("¡Error al conectarse!: " . $db->connect_error);
                ...
                $sql="SELECT `responsable`, `ubicacion`, `email`, `extension` FROM `departamentos` where `departamento`='Seguridad'";
                ...
                echo "<label for = \"Ubicacion\">Extensión: $fila->extension </label>";
